...
An easily maintainable human-friendly versions of the new schema is maintained at \url{http://ls.st/j7f}. Based on this spreadsheet, we have developed the updated database schema in the Felis/YAML format (delivered as a pull-request in Felis/YAML format to the \url{https://github.com/lsst/cat} package), as well as generated the \LaTeX{} tables in the DPDD.
